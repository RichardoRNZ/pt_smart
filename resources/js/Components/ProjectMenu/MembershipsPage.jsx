...
const CustomerPage = (props) => {
    ...
    const fetchCustomersData = async () => {
        try {
            setIsLoading(true);
            const response = await axios.get("/customer/memberships/data");
    ...
    const getCustomerDetails = async(id) => {
       try {
        const response = await axios.get("/subscribtion/active/" + id);
    ...
    return (
        <>
                            ...
                            >
                                <div className="card-body">
                                    <h5 className="card-title">
                                        <CardMembership /> Memberships List
                                    </h5>
            ...
            /> */}
            <DetailServices service={service}/>
            {/*
            <ConfirmModal
                id="deleteModal"
                type="delete"
